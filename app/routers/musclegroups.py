...
def read_musclegroup(*, session: Session = Depends(get_session), musclegroup_id: int):
...
def delete_musclegroup(*, session: Session = Depends(get_session), musclegroup_id: int):
